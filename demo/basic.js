...
//function defaultCallback(eventType, $srcObj, $tgtObj, srcSelector, tgtSelector, e) {}
...
dndx()
    ...
    //.onactivate(defaultCallback)
    //.ondeactivate(defaultCallback)
    //.onover(onOver)
    //.onout(onOut)
    .ondrop(onDrop);
...
$("#basic-dialog-link").click(function(event) {
